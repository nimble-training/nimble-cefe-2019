...
* Email the NIMBLE development team at: `nimble.stats@gmail.com`
...
And you can feel free email me directly (`dbt1@williams.edu`) given your participation in this workshop. However I do encourage you to post to the user group as any of the NIMBLE developers or other users can then help you out.

\  

### Participating in NIMBLE

* Email `nimble.stats@gmail.com` if you're interested in participating in the development of NIMBLE. 
